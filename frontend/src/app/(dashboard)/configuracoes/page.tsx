          ...
          <>
            ...
            <section className={styles.card}>
              ...
              <p className={styles.description}>
                Uma prova sem movimentacao por mais que esse tempo e
                considerada <strong>Atrasada</strong> (RN-008). Informe em
                horas uteis.
              </p>

              <form onSubmit={handleSubmitTempoAtraso} className={styles.form}>
                <div className={styles.field}>
                  ...
                  <div className={styles.inputInline}>
                    ...
                    <span className={styles.inputSuffix}>
                      de {TEMPO_ATRASO_MIN_HORAS} a {TEMPO_ATRASO_MAX_HORAS}
                    </span>
                  </div>
                </div>
            ...
            <section className={styles.card}>
              ...
              <form onSubmit={handleSubmitTemplate} className={styles.form}>
                <div className={styles.grid}>
                  ...
                  <div className={styles.field}>
                    <label htmlFor="template_formato" className={styles.label}>
                      Formato
                    </label>
                    <select
                      id="template_formato"
